Rails.application.routes.draw do
  ...
  patch '/pet_applications/:pet_id/:application_id/approved', to: 'pet_applications#approved'
  patch '/pet_applications/:pet_id/:application_id/denied', to: 'pet_applications#denied'

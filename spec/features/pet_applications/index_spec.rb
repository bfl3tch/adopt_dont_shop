...
RSpec.describe 'the pet applications index' do
  before(:each) do
    ...
    @pet_app_1 = @app_1.pets.create(name: 'Mr. Pirate', breed: 'tuxedo shorthair', age: 5, adoptable: true, shelter_id: @shelter_1.id)
    @pet_app_2 = @app_1.pets.create(name: 'Clawdia', breed: 'shorthair', age: 3, adoptable: true, shelter_id: @shelter_1.id)
    @pet_app_3 = @app_2.pets.create(name: 'Lucille Bald', breed: 'sphynx', age: 8, adoptable: true, shelter_id: @shelter_2.id)
    @pet_app_4 = @app_3.pets.create(name: 'Toby', breed: 'golden', age: 1, adoptable: true, shelter_id: @shelter_3.id)
